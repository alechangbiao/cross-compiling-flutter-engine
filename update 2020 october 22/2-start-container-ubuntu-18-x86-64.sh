...
cd /root
wget -qO- https://storage.googleapis.com/flutter_infra/releases/dev/linux/flutter_linux_1.24.0-1.0.pre-dev.tar.xz | tar xJf -
...
wget -q -O tmp.zip https://storage.googleapis.com/dart-archive/channels/dev/release/2.11.0-218.0.dev/sdk/dartsdk-linux-arm64-release.zip &&  unzip -q tmp.zip && rm tmp.zip
...
#
mkdir /sdk/root/
cp -R flutter  /sdk/root/
cp -R .config  /sdk/root/
cp -R .flutter /sdk/root/
